...
# Pull specific config file from git repo and overwrite local one; if config changes, reload will be triggered
./scripts/liteflow.sh update_conf_from_git --local <git_repo_url> <relative_conf_file_path>
